		...
		<div class="product_block">
 			 ...
 			 <div class="product-container clearfix">	
				...
				<div class="product-meta">
					<h5 class="name"><a href="{$product.link|escape:'htmlall':'UTF-8'}" title="{$product.name|truncate:150:'...'|escape:'htmlall':'UTF-8'}">{$product.name|truncate:35:'...'|escape:'htmlall':'UTF-8'}</a></h5>
