		...
		<div class="heading pull-right">
			<div class="mini-cart cart-inner">
				<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
					<span class="cart-title hide">{l s='shopping cart' mod='blockcart'}</span>
					<span class="ajax_cart_quantity mini-cart-count{if $cart_qties == 0} unvisible{/if}">{$cart_qties}</span>
					<span class="hide ajax_cart_product_txt{if $cart_qties != 1} unvisible{/if}">{l s='item' mod='blockcart'}</span>
					<span class="hide ajax_cart_product_txt_s{if $cart_qties < 2} unvisible{/if}">{l s='items' mod='blockcart'}</span>
					<span class="hide ajax_cart_total{if $cart_qties == 0} unvisible{/if}">
						{if $cart_qties > 0}
							{if $priceDisplay == 1}
					...
					<span class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}">
						<span class="mini-cart-count">{l s='0' mod='blockcart'} </span> 
					</span>
