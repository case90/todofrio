<div id="blog-localengine">
		...
		<div class="comments">
			...
			<div class="comment-item" id="comment{$comment.id_comment}">
				<img src="http://www.gravatar.com/avatar/{md5(strtolower(trim($comment.email)))}?d={urlencode($default)}&s=60" alt=""/>							
		...
		<form class="form-horizontal" method="post" id="comment-form" action="{$blog_link}" onsubmit="return false;">
			...
			<div class="form-group">
				...
				<div class="col-lg-9">
					<textarea name="comment" rows="6"  placeholder="{l  s='Enter your comment' mod='leoblog'}" id="inputComment" class="form-control"></textarea>
				</div>
			</div>
			 <div class="form-group">
			 	<label class="col-lg-3 control-label" for="inputEmail">{l s='Captcha' mod='leoblog'}</label>
			 	<div class="col-lg-8 col-md-8 ipts-captcha">
			 		 <img src="{$captcha_image}" class="comment-capcha-image" alt=""/>
