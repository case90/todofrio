...
{if !empty($products )}
	...
	<div id="homefeatured" class="block products_block slide exclusive ptsblockprodcarousel carousel info">
		<h4 class="title_block"><span>{l s='Featured products' mod='ptsblockprodcarousel'}</span></h4>
