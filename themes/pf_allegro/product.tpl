...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block">
		...
		<div class="row">
			...
			<!-- end left infos-->
			<!-- center infos -->
			<div class="pb-right-column col-xs-12 col-sm-12 col-md-6 col-lg-6 space-padding-lr-30 space-padding-tb-30">
							...
							<div class="product_attributes clearfix">
								...
								<div class="button-bottom">
									...
									<div class="compare buttons_bottom_block">
	                                    <a class="btn add_to_compare custom-tooltip" href="{$link->getProductLink($product)|escape:'html':'UTF-8'}" title="{l s='Add To Compare'}" data-id-product="{$product->id|escape:'html':'UTF-8'}">
	                                            {l s='ADD TO COMPARE'}
	                                    </a>
	                                </div>
	                                <div class="hide">
				...
				{if class_exists('PtsthemePanel')}
					{plugin module='socialsharing' hook='displayRightColumnProduct'}
				{/if}
				{if class_exists('PtsthemePanel')}										
		...
		<div class="tabs-info block">
			<div class="tab-nav">
				<ul class="nav nav-pills" role="tablist">
					...
					<li><a href="#producttab-accessories" data-toggle="tab">{l s='accessories'}</a></li>
					{/if}
					{if isset($HOOK_PRODUCT_TAB_CONTENT) && $HOOK_PRODUCT_TAB_CONTENT}
                           <li><a id="link_idTab5" href="#idTab5" data-toggle="tab" class="idTabHrefShort selected">{$HOOK_PRODUCT_TAB}</a></li>
			...
			<div class="tab-content tab_product_content">
				...
				{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
					<!-- quantity discount -->
					<div id="quantityDiscount" class="tab-pane fade">
				...
				{if isset($features) && $features}
					<!-- Data sheet -->
					<div id="producttab-datasheet" class="tab-pane fade">
				...
				<div id="producttab-accessories" class="block products_block  tab-pane fade" >
					...
					{$nbr_desktops = Configuration::get('PTS_CP_PRODUCT_ACCROW')}
					{$nbr_tablets = 2}
					{$nbr_mobile = 1}
					{include file="$tpl_dir./sub/products_module.tpl" items=$accessories class="products-block grid {if isset($product_style) && !empty($product_style)}{$product_style}{else}style1{/if}" carousel_style="boxcarousel"}
					</div>
				</div>
				<!-- end Accessories -->
			{/if}
				{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
						{if isset($attachments) && $attachments}
							<!--Download -->
							<div class="tab-pane" id="producttab-download">
						...
						{if isset($product) && $product->customizable}
							<!--Customization -->
							<div class="tab-pane" id="producttab-customization">
