...
<div class="adresses_bloc">
	<div class="row">
		<div class="col-xs-12 col-sm-6"{if $order->isVirtual()} style="display:none;"{/if}>
			<ul class="list-unstyled address alternate_item">
		...
		<div class="col-xs-12 col-sm-6">
			<ul class="list-unstyled address item {if $order->isVirtual()}full_width{/if}">
...
{if $carriers|count > 0 && isset($carriers.0.carrier_name) && $carriers.0.carrier_name}
	<table class="table table-bordered footab">
		...
		<tfoot>
			<tr>
				<td colspan="5">{$HOOK_ADDITIONAL_SHIPPING_INFO}</td>
			</tr>
		</tfoot>
	</table>
{/if}
