...
/*DATA FOR TABLE leoblog_blog*/
 $query_sql['leoblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'leoblog_blog( `id_leoblog_blog`,`id_leoblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'3\', \'4\', \'0\', \'2013-11-28\', \'1\', \'0\', \'41\', \'b-blog-1.jpg\', \'2013-12-20 09:55:38\', \'<iframe width=\"560\" height=\"315\" src=\"//www.youtube.com/embed/lzY4lkT8ElU\" frameborder=\"0\" allowfullscreen></iframe>\', \'\', \'0\', \'1\', \'1\', \'\')'; 
 $query_sql['leoblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'leoblog_blog( `id_leoblog_blog`,`id_leoblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'4\', \'4\', \'2\', \'2013-12-04\', \'1\', \'0\', \'106\', \'b-blog-2.jpg\', \'2013-12-18 06:31:14\', \'\', \'\', \'0\', \'1\', \'1\', \'\')'; 
 $query_sql['leoblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'leoblog_blog( `id_leoblog_blog`,`id_leoblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'5\', \'4\', \'3\', \'2013-12-16\', \'1\', \'0\', \'11\', \'b-blog-3.jpg\', \'2013-12-19 01:21:28\', \'\', \'\', \'0\', \'0\', \'1\', \'\')'; 
 $query_sql['leoblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'leoblog_blog( `id_leoblog_blog`,`id_leoblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'6\', \'4\', \'4\', \'2013-12-18\', \'1\', \'0\', \'148\', \'b-blog-4.jpg\', \'2013-12-20 09:54:03\', \'\', \'\', \'0\', \'0\', \'1\', \'\')'; 
 $query_sql['leoblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'leoblog_blog( `id_leoblog_blog`,`id_leoblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'7\', \'4\', \'5\', \'2013-12-18\', \'1\', \'0\', \'75\', \'b-blog-5.jpg\', \'2013-12-20 01:04:46\', \'\', \'\', \'0\', \'0\', \'1\', \'\')'; 
 $query_sql['leoblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'leoblog_blog( `id_leoblog_blog`,`id_leoblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'8\', \'4\', \'1\', \'2013-12-18\', \'1\', \'0\', \'11\', \'b-blog-6.jpg\', \'2013-12-19 22:50:10\', \'\', \'\', \'0\', \'0\', \'1\', \'\')'; 
 $query_sql['leoblog_blog'][] = 'INSERT INTO '._DB_PREFIX_.'leoblog_blog( `id_leoblog_blog`,`id_leoblogcat`,`position`,`date_add`,`active`,`user_id`,`hits`,`image`,`date_upd`,`video_code`,`params`,`featured`,`indexation`,`id_employee`,`product_ids` ) 
							VALUES(\'9\', \'4\', \'6\', \'2013-12-18\', \'1\', \'0\', \'25\', \'b-blog-7.jpg\', \'2013-12-18 03:32:42\', \'\', \'\', \'0\', \'1\', \'1\', \'\')'; 
