				...
				<div class="col-01 col-xs-12 col-md-4">
					...
					<div class="col_01_body">
						<div class="col_01_body_row">
							...
							<div class="axsTitle04 weight_bold">{$total}</div>
						</div>
						<div class="col_01_body_row">
							<div>{l s='Referencia' mod='oxxodeposit'}</div>
							<div class="axsTitle04 weight_bold">{$reference}</div>
						</div>
						<div class="col_01_body_row">
							<div>{l s='Folio de la orden' mod='oxxodeposit'}</div>
							<div class="axsTitle04 weight_bold">{$id_order}</div>
						</div>
						<div class="col_01_body_row">
