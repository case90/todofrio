...
class BankWire extends PaymentModule
{
	...
	public function __construct()
	{
		...
		$config = Configuration::getMultiple(array('BANK_WIRE_DETAILS', 'BANK_WIRE_OWNER', 'BANK_WIRE_ADDRESS', 'BANK_WIRE_DESCRIPTION'));
		...
		if (!empty($config['BANK_WIRE_DESCRIPTION']))
			$this->bankwire_description = $config['BANK_WIRE_DESCRIPTION'];
		...
		if (!isset($this->owner) || !isset($this->details) || !isset($this->address) || !isset($this->bankwire_description))
		...
		$this->extra_mail_vars = array(
										...
										'{bankwire_description}' => nl2br(Configuration::get('BANK_WIRE_DESCRIPTION')),
										);
	}

	public function install()
	{
		if (!parent::install() || !$this->registerHook('payment') || !$this->registerHook('backOfficeHeader') || ! $this->registerHook('displayPaymentEU') || !$this->registerHook('paymentReturn'))
			return false;
		return true;
	}
	...
	public function uninstall()
	{
		if (!Configuration::deleteByName('BANK_WIRE_DETAILS')
				...
				|| !Configuration::deleteByName('BANK_WIRE_DESCRIPTION')
				|| !parent::uninstall())
			return false;
		return true;
	}
	...
	protected function _postProcess()
	{
		if (Tools::isSubmit('btnSubmit'))
		{
			...
			Configuration::updateValue('BANK_WIRE_DESCRIPTION', Tools::getValue('BANK_WIRE_DESCRIPTION'), true);
		}
	...
	public function hookPaymentReturn($params)
	{
		...
		if (in_array($state, array(Configuration::get('PS_OS_BANKWIRE'), Configuration::get('PS_OS_OUTOFSTOCK'), Configuration::get('PS_OS_OUTOFSTOCK_UNPAID'))))
		{
			$this->smarty->assign(array(
				...
				'bankwireDescription' => Tools::nl2br($this->bankwire_description),
	...
	public function getConfigFieldsValues()
	{
		return array(
			...
			'BANK_WIRE_DESCRIPTION' => Tools::getValue('BANK_WIRE_DESCRIPTION', Configuration::get('BANK_WIRE_DESCRIPTION')),
		);
	}
}
