		...
		<div class="row">
			<div class="col-lg-6">
				{if isset($input['image']) && $input['image']}
					<img src="{$input['image']|escape:'htmlall':'UTF-8'}" class="img-thumbnail" />
					<br>
					<input type="checkbox" name="delete_icon" value="1"> {l s='Delete Icon' mod='psverticalmenu'}
				{/if}
				...
				<div class="dummyfile input-group">
					...
					<span class="input-group-btn">
						<button id="{$input.name|escape:'htmlall':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
							<i class="icon-folder-open"></i> {l s='Choose a file' mod='psverticalmenu'}
						</button>
					</span>

				</div>
				<p class="help-block">{l s='Use image icon if no use con Class' mod='psverticalmenu'}</p>
				<script>
