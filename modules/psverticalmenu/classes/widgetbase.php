...
abstract class PsVerticalMenuWidgetBase extends Module  {
	...
	public function getFormHelper()
	{
		...
		$helper->toolbar_btn = array(
			'back' => array(
				'desc' => $this->l('Back'),
				'href' => AdminController::$currentIndex.'&configure='.$this->mod_name.'&save'.$this->mod_name
					.'&token='.Tools::getAdminTokenLite('AdminModules').'&widgets=1&rand='.rand(),
			),
		);
