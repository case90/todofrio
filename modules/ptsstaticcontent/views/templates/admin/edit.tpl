...
*}
<form method="post" action="{$postAction|escape:'htmlall':'UTF-8'}&formedit=1&id_item={$hItem.id_item|escape:'htmlall':'UTF-8'}" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
    <input type="hidden" name="id_lang" value="{$lang.id_lang|escape:'htmlall':'UTF-8'}" />
    ...
    <div class="image-display item-field form-group" style="text-align:center">
       <img src="{$module_dir|escape:'htmlall':'UTF-8'}views/img/{$hItem.image|escape:'htmlall':'UTF-8'}" alt="" title="" style="max-width:100%;{if !$hItem.image} display:none;{/if}" class="preview" />
   </div>
   <div class="delete item-field form-group">
       ...
       <div class="col-lg-7">
           ...
           <input type="hidden" name="old_image_name" value="{$hItem.image|escape:'htmlall':'UTF-8'}">
       </div>
   </div>
   ...
   <div class="title_use item-field form-group">
    ...
    <div class="image_w item-field form-group">
        ...
        <div class="col-lg-7">
            <input name="class" type="text" size="4" value="{$hItem.class|escape:'htmlall':'UTF-8'}"/>
        </div>
    </div>
   ...
   <div class="hook item-field form-group">
       ...
       <div class="col-lg-7">
           <select name="item_hook" default="home">
               ...
               <option value="{$modhook|escape:'htmlall':'UTF-8'}" {if $hItem.hook == $modhook} selected="selected"{/if}>{$modhook|escape:'htmlall':'UTF-8'}</option>  
               {/foreach}
           </select>
       </div>
   </div>
   ...
   <div class="image_h item-field form-group">
    ...
    <div class="col_lg item-field form-group">
        ...
        <div class="col-lg-7">
            <input name="col_lg" type="text" maxlength="4" size="4" value="{$hItem.col_lg|escape:'htmlall':'UTF-8'}"/>
        </div>
    </div>
   ...
   <div class="html item-field form-group">
       ...
       <div class="col-lg-7">
           <textarea name="item_html" class="rte autoload_rte" cols="65" rows="12">{$hItem.html}{* HTML, can not escape *}</textarea>
       </div>
   </div>
